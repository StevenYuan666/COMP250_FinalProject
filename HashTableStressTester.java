...
public class HashTableStressTester{
 ...
 public static void readStressTestFiles(String tweetsFileName, String stopWordsFileName) {
	 ...
	 DateTimeFormatter dateFormatFile = DateTimeFormatter.ofPattern("EEE MMM dd HH:mm:ss xx yyyy", new Locale("en", "US"));
	 DateTimeFormatter dateFormatTweets = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss", new Locale("en", "US"));
